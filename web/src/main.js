  ...
  try{
    ...
    const save=async submitted=>{const saveButton=document.querySelector(submitted?'#submitEntry':'#saveEntryDraft'),editorList=[...editors.querySelectorAll('.work-editor')];try{
      ...
      for(const editor of editorList){
        ...
        let workId=editor.dataset.id,sortOrder=Number(editor.dataset.sortOrder)||nextSort++,originalPath=editor.dataset.originalPath||null,originalFileName=editor.dataset.originalFileName||'',previewPath=editor.dataset.previewPath||null
        ...
        const payload={title:editor.querySelector('[name=title]').value.trim(),caption:editor.querySelector('[name=caption]').value.trim(),note:editor.querySelector('[name=note]').value.trim(),original_image_path:originalPath,original_file_name:originalFileName,preview_image_path:previewPath,status:submitted?'submitted':'draft'}
